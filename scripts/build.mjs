...
try {
    _build({
        ...
        copyFileSync('.zeabur/output/functions/index.func/users.js', '.zeabur/output/functions/users/get.func/index.js')
        rmSync('.zeabur/output/functions/index.func/users.js')
    })
} catch (error) {
    console.error(error)
}
